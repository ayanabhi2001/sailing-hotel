...
<!-- Mirrored from techydevs.com/demos/themes/html/trizen-demo/trizen/checkout.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jun 2022 21:15:38 GMT -->
<head>
    <meta http-equiv="content-type" content="text/html; charset=utf-8">
    <meta name="author" content="TechyDevs">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
    <title>Sailing Hotel - Online Booking site</title>
    <!-- Favicon -->
            ...
            <div class="col-lg-8">
                <div class="form-box">
                    ...
                    <div class="form-content ">
                        ...
                        ?>
                            <form method="post"  action="payment_handle.php?roomid=<?php echo $roomid;?>&check_in=<?php echo $check_in;?>&check_out=<?php echo $check_out;?>&adults=<?php echo $adults;?>&childrens=<?php echo $childrens;?>&total_price=<?php echo $total_price; ?>">
                                    ...
                                    <div class="col-lg-6 responsive-column">
                                        <div class="input-box">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" pattern="[a-zA-Z'-'\s]*" title="Please enter a valid name " name="fname" placeholder="First name" required>
                                            </div>
                                        </div>
                                    </div><!-- end col-lg-6 -->
                                    <div class="col-lg-6 responsive-column">
                                        <div class="input-box">
                                            ...
                                            <div class="form-group">
                                                <span class="la la-user form-icon"></span>
                                                <input class="form-control" type="text" pattern="[a-zA-Z'-'\s]*" title="Please enter a valid name " name="lname" placeholder="Last name" required>
                                            </div>
                                        </div>
                                    </div><!-- end col-lg-6 -->
                                    <div class="col-lg-6 responsive-column">
                                        <div class="input-box">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="email" name="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" placeholder="Email address" required>
                                            </div>
                                        </div>
                                    </div><!-- end col-lg-6 -->
                                    <div class="col-lg-6 responsive-column">
                                        <div class="input-box">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="number" name="phone" pattern="[789][0-9]{9}" placeholder="Phone Number" title="Please enter a number of 10 digits starts with 7,8,9" required>
                                            </div>
                                        </div>
                                    </div><!-- end col-lg-6 -->
                                    <div class="col-lg-12 responsive-column">
                                        <div class="input-box">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" pattern="^[#.0-9a-zA-Z\s,-]+$"  title="Please enter a valid address" name="address" placeholder="Address line" required>
                                            </div>
                                        </div>
                                    </div><!-- end col-lg-12 -->
                                    <div class="col-lg-6 responsive-column">
                                            ...
                                            <div class="form-group">
                                                <div class="select-contain w-auto">
                                                    <select class="select-contain-select">
                                                        ...
                                                        <option value="6" selected>India (+91)</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <ul class="nav nav-tabs justify-content-center" id="myTab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="credit-card-tab" data-toggle="tab" href="#credit-card" role="tab" aria-controls="credit-card" aria-selected="false">
                                        ...
                                        <img src="extra_css/images/payment-img.png" alt="">
                                        <span class="d-block pt-2">Payment with credit card</span>
                                    </a>
                                </li>
                                <li class="nav-item  " style="opacity: 0;">
                                    <a class="nav-link" id="paypal-tab" data-toggle="tab" href="" role="tab" aria-controls="paypal" aria-selected="true">
                                        <i class="la la-check icon-element"></i>
                                        <img src="extra_css/images/paypal.png" alt="">
                                        <span class="d-block pt-2">Payment with PayPal</span>
                                    </a>
                                </li>
                                <li class="nav-item" style="opacity: 0;">
                                    <a class="nav-link" id="payoneer-tab" data-toggle="tab" href="" role="tab" aria-controls="payoneer" aria-selected="true">
                                        <i class="la la-check icon-element"></i>
                                        <img src="extra_css/images/payoneer.png" alt="">
                            ...
                            <div class="tab-pane fade show active" id="credit-card" role="tabpanel" aria-labelledby="credit-card-tab">
                                <div class="contact-form-action">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="input-box">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" type="text" pattern="[a-zA-Z'-'\s]*" title="Please enter a valid name " name="text" placeholder="Card holder name" required>
                                                    </div>
                                                </div>
                                            </div><!-- end col-lg-6 -->
                                            <div class="col-lg-6">
                                                <div class="input-box">
                                                    ...
                                                    <div class="form-group">
                                                        <span class="la la-credit-card form-icon"></span>
                                                        <input class="form-control" type="text" pattern="^4[0-9]{12}(?:[0-9]{3})?$|^3[47][0-9]{13}$|^(5[1-5][0-9]{14}|2(22[1-9][0-9]{12}|2[3-9][0-9]{13}|[3-6][0-9]{14}|7[0-1][0-9]{13}|720[0-9]{12}))$" title="Supported Cards (Master Card, Amex Card, Visa Card" name="c_no" placeholder="Card number" required>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="input-box">
                                                            ...
                                                            <div class="form-group">
                                                                <span class="la la-credit-card form-icon"></span>
                                                                <input class="form-control" type="number" title="Enter two digit " maxlength="2" pattern="[0-9]{2}" name="text" placeholder="MM" required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6">
                                                        <div class="input-box">
                                                            ...
                                                            <div class="form-group">
                                                                <span class="la la-credit-card form-icon"></span>
                                                                <input class="form-control" type="number" title="Enter two digit " maxlength="2" pattern="[0-9]{2}" name="text" placeholder="YY" required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="input-box">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" type="text" title="Enter Three  digit cvv " pattern="[0-9]{3}" name="text" placeholder="CVV" required>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="btn-box">
                                                    <button class="theme-btn" type="submit" name="book">Confirm Booking</button>
                                                </div>
                                            </div><!-- end col-lg-12 -->
                                        </div>
</form>
				  ...
				  ?>
                            <div class="card-img pb-4">
                                <a href="room-details.php" class="d-block">
                                    <img src="admin/room/<?php echo $row['image']; ?>" alt="room-img">
                                </a>
                            </div>
                      ...
                      $total_price=$_REQUEST['total_price'];
                            ...
                            <div class="card-body p-0">
                                ...
                                <ul class="list-items list-items-2 list-items-flush py-2">
                                    <li class="font-size-15"><span class="w-auto d-block mb-n1"><i class="la la-calendar mr-1 font-size-17"></i>From</span><?php echo $check_in; ?> 2:00pm</li>
                                    <li class="font-size-15"><span class="w-auto d-block mb-n1"><i class="la la-calendar mr-1 font-size-17"></i>To</span><?php echo $check_out; ?> 12:00am</li>
                                </ul>
                                ...
                                <?php 
                                    ...
                                    ?>
                                    <li><span>Room Type:</span><?php echo $row['room_type']; ?></li>
                                    <li><span>Night:</span><?php echo $numberDays; ?></li>
                                    <?php }?>
                                    <li><span>Guests:</span> <?php echo $adults+$childrens; ?></li>
                                    <!-- <li><span>Extra Services:</span>Cleaning, Laundry, Breakfast</li> -->
                                </ul>
                                <div class="section-block"> </div>
                                <ul class="list-items list-items-2 pt-3">
                                    <li><span>Sub Total:</span>&#8377  <?php echo $total_price ?> </li>
                                    <li><span>Taxes And Fees:</span>&#8377 5</li>
                                    <li><span>Total Price:</span>&#8377  <?php echo $total_price+5; ?> </li>
                                </ul>
                            </div>
                        </div><!-- end card-item -->
                    </div><!-- end form-content -->
