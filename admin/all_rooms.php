...
<!-- Mirrored from www.einfosoft.com/templates/admin/spice/source/all_rooms.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Apr 2022 16:16:48 GMT -->
<head>
	<meta charset="utf-8" />
											...
											<tbody>
												<tr class="odd gradeX">
													<!-- <td class="user-circle-img">
														<img src="admin/room/" alt="">
													</td> -->
													<td class="center"><?php echo $data['room_number']; ?></td>
													<td class="center"><?php echo $data['room_type']; ?></td>
													<!-- <td class="center"></td> -->
													<td class="center"><?php echo $data['ac_nonac']; ?></td>
													<td class="center"><?php echo $data['meal']; ?></td>
													<td class="center"><?php echo $data['max_persions']; ?></td>
													<td class="center"><?php echo $data['telephone_number']; ?></td>
													<td class="center"><?php echo $data['price_per_night']; ?></td>
													<td class="center">
														<a href="editroom.php?roomid=<?php echo $data['room_number'];?>" class="btn btn-tbl-edit btn-xs">
															<i class="fa fa-pencil"></i>
														</a>
														<a class="btn btn-tbl-delete btn-xs" href="delete_room.php?roomid=<?php echo $data['room_number'];?>">
