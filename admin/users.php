...
<!-- Mirrored from www.einfosoft.com/templates/admin/spice/source/view_booking.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Apr 2022 16:16:47 GMT -->
<head>
	<meta charset="utf-8" />
										...
										<table class="table table-hover table-checkable order-column full-width"
											...
											<tbody>
												<tr class="odd gradeX">
													...
													<td class="center">
													<?php echo $data['fname']." ".$data['lname']; ?> </td>
													<td class="center"><a href="mailto:<?php echo $data['uemail']; ?>">
													<?php echo $data['uemail']; ?> </a></td>
													<td class="center"><?php echo $data['uaddress']; ?></td>
													<td class="center"><?php echo $data['uphone']; ?></td>
...
<!-- Mirrored from www.einfosoft.com/templates/admin/spice/source/view_booking.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Apr 2022 16:16:48 GMT -->
</html>