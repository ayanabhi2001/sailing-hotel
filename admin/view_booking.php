										...
										<table class="table table-hover table-checkable order-column full-width"
											...
											<thead>
												<tr>
												   <th class="center"> ID </th>
													...
													<!-- <th class="center"> Room T </th> -->
													<th class="center"> Room No.</th>
													<th class="center"> Payment </th>
													<th class="center" hidden> Action </th>
												</tr>
											</thead>
											<?php
											...
											<tbody>
												<tr class="odd gradeX">
													...
													<td class="center"><?php echo $data['cart_id']; ?></td>
													<td class="center"><?php echo $data['booking_name']; ?></td>
													<td class="center">
													<?php echo $data['phone']; ?> </td>
													<td class="center"><a href="mailto:<?php echo $data['booking_email']; ?>">
													<?php echo $data['booking_email']; ?> </a></td>
													<td class="center"><?php echo $data['check_in']; ?></td>
													<td class="center"><?php echo $data['check_out']; ?></td>
													<td class="center"><?php echo $data['room_id']; ?></td>
													<!-- <td class="center"><?php echo $data['room_number']; ?></td> -->
													<td class="center">
														<span class="label label-sm label-success">Paid </span>
													</td>
													<td class="center" hidden>
														<a href="edit_booking.php?id=<?php echo $data['cart_id'];?>" class="btn btn-tbl-edit btn-xs">
															<i class="fa fa-pencil"></i>
														</a>
														<a class="btn btn-tbl-delete btn-xs" href="delete_booking.php?bookingid=<?php echo $data['cart_id'];?>">
