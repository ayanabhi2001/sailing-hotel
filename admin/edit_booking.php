...
<!-- Mirrored from www.einfosoft.com/templates/admin/spice/source/edit_booking.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Apr 2022 16:16:48 GMT -->
<head>
	<meta charset="utf-8" />
	...
	<title>Sailng Hotel | Admin Dashboard</title>
	<!-- icons -->
			...
			<div class="page-header-inner ">
				...
				<div class="page-logo">
					<a href="index.html">
						...
						<span class="logo-default">Sailng </span> </a>
				</div>
				<!-- logo end -->
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="card-box">
                                ...
                                $bookid=$_GET['id'];
                                $sql="SELECT * FROM `cart` WHERE cart_id= {$bookid}";
								...
								<form action="updatebookinghandle.php" method="POST">
								...
								<div class="card-body row">
									...
									<div class="col-lg-6 p-t-20">
										<div
											...
											<input class="mdl-textfield__input" type="text" name="booking_id" value="<?php echo $row['cart_id'];?>"
												id="txtFirstName">
									...
									<div class="col-lg-6 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<input class="mdl-textfield__input" type="text" name="room_number" value="<?php echo $row['room_id'];?>"
												id="txtFirstName">
									...
									<div class="col-lg-6 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<input class="mdl-textfield__input" type="text" name="name" value="<?php echo $row['booking_name'];?>"
												id="txtFirstName">
									...
									<div class="col-lg-6 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<input class="mdl-textfield__input" type="email" name="email" value="<?php echo $row['booking_email'];?>"
												id="txtemail">
									...
									<!-- <div class="col-lg-6 p-t-20">
										<div
											...
											<input class="mdl-textfield__input" type="text" id="list3" name="room_type" value=""
												readonly tabIndex="-1">
									...
									<div class="col-lg-6 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<input class="mdl-textfield__input" type="text" name="phone" value="<?php echo $row['phone'];?>"
									...
									<div class="col-lg-6 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<input class="mdl-textfield__input" type="text" name="arrival_date" value="<?php echo $row['check_in'];?>"
												id="date">
									...
									<div class="col-lg-6 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<input class="mdl-textfield__input" type="text" name="depart_date" value="<?php echo $row['check_out'];?>"
												id="date">
									...
									<div class="col-lg-6 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select getmdl-select__fix-height txt-full-width">
											<input class="mdl-textfield__input" type="text" id="list2" name="noofadults" value="<?php echo $row['adults'];?>"
												readonly tabIndex="-1">
									...
									<div class="col-lg-6 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select getmdl-select__fix-height txt-full-width">
									        <input class="mdl-textfield__input" type="text" id="list2" name="noofchildrens" value="<?php echo $row['childrens'];?>"
												readonly tabIndex="-1">
											<label for="list2" class="pull-right margin-0">
												<i class="mdl-icon-toggle__label material-icons">keyboard_arrow_down</i>
											</label>
									...
									<div class="col-lg-12 p-t-20">
										<div class="mdl-textfield mdl-js-textfield txt-full-width">
											<textarea class="mdl-textfield__input" rows="2"
												id="text7" name="address"><?php echo $row['address'];?></textarea>
											<label class="mdl-textfield__label" for="text7">Customer Address</label>
										</div>
									</div>
									...
									<div class="col-lg-12 p-t-20 text-center">
										<button type="submit"
											class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 m-r-20 btn-pink" name="updatebooking">Submit</button>
										<button type="button"
